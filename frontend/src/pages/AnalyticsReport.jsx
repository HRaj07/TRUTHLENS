...
const AnalyticsReport = () => {
  ...
  if (!report) return (
     <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-10 text-center">
        ...
        <button onClick={() => navigate(-1)} className="btn-secondary">Return to Dashboard</button>
     </div>
  );
      ...
      <header className="glass-dark border-b border-slate-800/50 py-6 px-6 sticky top-0 z-20">
         <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div className="flex items-center gap-4">
               <button onClick={() => navigate(-1)} className="p-2 hover:bg-slate-800 rounded-lg transition-colors text-slate-400">
